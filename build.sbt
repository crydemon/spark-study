...
libraryDependencies += "com.alibaba" % "druid" % "1.1.21" exclude("org.slf4j", "slf4j-jdk14")

// https://mvnrepository.com/artifact/org.apache.kafka/kafka-clients
libraryDependencies += "org.apache.kafka" % "kafka-clients" % "2.4.0" exclude("org.slf4j", "slf4j-jdk14")
